...
class AuthControllerTest {
    ...
    void setUp() throws ParseException, JSONException {
        ...
        authController = new AuthController(authenticationService, jwtSecurity, zosmfService, messageService, tokenProvider, null, null, oidcProvider, webFingerProvider);
